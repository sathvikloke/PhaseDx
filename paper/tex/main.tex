...
a label-file audit of seven public benchmarks,\\
and a protocol-frozen random-sample screen\\
of how often the check is reported}
...
Aditya Raut --- Neuqua Valley High School, Naperville, Ill.\\[0.4em]
...
\textbf{Conflicts of interest} \todo{CONFIRM: each author must state COI or ``none''}\\
\end{tabular}
\end{center}
