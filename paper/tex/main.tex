...
\textbf{Conflicts} & \todo{CONFIRM: each author must state COI or ``none''}\\[0.35em]
...
the reserve blocks and the pooling script --- are released at \todo{MISSING: public
repository URL and archival DOI}. The 44 unreachable records are listed by PMID so
a reader with better access can complete the screen.
