...
- [~] Unanonymized acknowledgments — **mostly filled 2026-08-12.** The
      ...
      the manuscript: it leads with the verifiable claim that no reported value was
      generated by a language model, then states assistance in drafting **and** in
      implementing the analysis code;
      tool **Claude (Opus 5), Anthropic**; access **2026-07-27 to 2026-08-14**. Two
