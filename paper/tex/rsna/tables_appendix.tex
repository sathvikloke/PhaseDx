% =====================================================================
%  SUPERSEDED -- NOT PART OF THE SUBMISSION, NOT BUILT, DO NOT UPLOAD
%
%  This file predates the 2026-08-14/15 revision and its contents are
%  stale in at least three ways: it lists the two fastMRI+ knee arms,
%  which are withdrawn; it states that the official label file "was never
%  obtained", which is no longer true -- it was obtained and reconciled
%  row for row with zero disagreements; and it predates the PI-CAI
%  slice-level arm entirely.
%
%  The material it carried now lives in the Table 2 note and Table 4 of
%  main.tex. Nothing includes this file and nothing builds it. It is kept
%  only so the earlier draft's supplemental tables remain in the history.
%  If you need supplemental material, supplement.tex is the live one.
% =====================================================================
